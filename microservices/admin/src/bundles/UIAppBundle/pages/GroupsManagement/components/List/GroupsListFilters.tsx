...
import { GroupListFiltersForm } from "../../config/GroupListFiltersForm";

type GroupsListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const GroupsListFilters = React.memo(GroupsListFiltersBase);

export function GroupsListFiltersBase(props: GroupsListFiltersProps) {
  ...
  const filterForm = use(GroupListFiltersForm, { transient: true });
  filterForm.build();
