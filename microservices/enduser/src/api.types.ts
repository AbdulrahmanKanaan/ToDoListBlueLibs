...
export type Mutation = {
  ...
  GroupsInsertOne?: Maybe<Group>;
  GroupsUpdateOne: Group;
  GroupsDeleteOne?: Maybe<Scalars['Boolean']>;
...
export type MutationGroupsInsertOneArgs = {
  document: GroupInsertInput;
};


export type MutationGroupsUpdateOneArgs = {
  _id: Scalars['ObjectId'];
  document: GroupUpdateInput;
};


export type MutationGroupsDeleteOneArgs = {
  _id: Scalars['ObjectId'];
};
...
export type Query = {
  __typename?: 'Query';
  GroupsFindOne?: Maybe<Group>;
  GroupsFind: Array<Maybe<Group>>;
...
export type QueryGroupsFindOneArgs = {
  query?: Maybe<QueryInput>;
};


export type QueryGroupsFindArgs = {
  query?: Maybe<QueryInput>;
};
...
export type Subscription = {
  ...
  GroupsSubscription?: Maybe<SubscriptionEvent>;
  GroupsSubscriptionCount?: Maybe<SubscriptionCountEvent>;
...
export type SubscriptionGroupsSubscriptionArgs = {
  body?: Maybe<Scalars['EJSON']>;
};


export type SubscriptionGroupsSubscriptionCountArgs = {
  filters?: Maybe<Scalars['EJSON']>;
};
